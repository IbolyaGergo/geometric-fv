...
\begin{figure}[p] % 'p' forces a dedicated page
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includestandalone[mode=buildnew]{fig/godunov_reconstruct}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includestandalone[mode=buildnew]{fig/godunov_evolve}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includestandalone[mode=buildnew]{fig/godunov_average}
    \end{subfigure}
...
\begin{figure}[ht]
    \centering
    \includestandalone[mode=buildnew]{fig/godunov_flux}
...
\begin{figure}[ht]
    \centering
    \includestandalone[mode=buildnew]{fig/linear_flux}
...
\begin{figure}[h]
    \centering
    \includestandalone[mode=buildnew]{fig/linear_slopes}
    \caption{}
